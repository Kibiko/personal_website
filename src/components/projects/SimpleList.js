import './projects-css/SimpleList.css'
        ...
        <div>
            <div className='simple-list-container'>
                <div className='overlay-pictures'>
                    <img className='under-image' src="simple-list-screen.png"/>
                    <img className='over-image' src="simple-list.png"/>
                </div>
                <div className='simple-list-paragraph'>
            ...
            <Modal
                ...
                >
                <Box className="simple-demo-modal">
