import './projects-css/Platformer.css'
        ...
        <div>
            <div className='platformer-container'>
                <div className='overlay-pictures'>
                    <img className='under-image' src="platformer-screen.png"/>
                    <img className='over-image' src="platformer.png"/>
                </div>
                <div className='platformer-paragraph'>
