      ...
      <Collapse in={open}>
        <div id="mobile-about-me">
          <div className='mobile-about-me-paragraph'>
            ...
            <p className="mobile-about-me-end">My goal for the forseeable future is to learn more about how my skills can be adapted to industry and to make an impact, adding value and contributing to solutions which interest me. The growth mindset never ends as the journey through life has limitless opportunities.</p>
          </div>
        </div>
      </Collapse>
    </div>
